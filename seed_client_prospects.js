...
async function main() {
    console.log('Seeding client_prospects data...');
    
    // Insert all client prospects
    const results = [];
    ...
    // Get count of all client prospects
    const countResult = await query('SELECT COUNT(*) as count FROM client_prospects');
    ...
    fs.writeFileSync('seed_client_prospects_result.json', JSON.stringify(output, null, 2));
